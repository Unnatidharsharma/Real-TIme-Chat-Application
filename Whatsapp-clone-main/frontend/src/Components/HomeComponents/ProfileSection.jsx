...
const ProfileSection = ({
  ...
  return (
    <div className="flex justify-between items-center p-3">
      <div onClick={handleNavigate} className="flex items-center space-x-3 cursor-pointer hover:bg-gray-100 p-2 rounded">
        <img
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Click to set language preference</p>
        </div>
      </div>
